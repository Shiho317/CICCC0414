...
const booleanMark = (isMark: boolean) => {
  if(isMark){
    console.log("[Exercise 1.2]",  "Oh, hi Mark")
  }else{
    console.log("[Exercise 1.2]", "Who are you?")
  }
}
  
  let friend = booleanMark(true);
  let stranger = booleanMark(false);
